...
export type RuntimeMessage =
  ...
  | { type: typeof MSG_TRANSLATE_TEXT; payload: { text: string; sourceLanguage: LanguageCode | 'auto'; targetLanguage: LanguageCode } }
  | { type: typeof MSG_UPDATE_HOTKEY; payload: { hotkeyModifier: 'alt' | 'control' | 'shift' } }
  | { type: typeof MSG_EASTER_CONFETTI }
  | { type: typeof MSG_WARM_TRANSLATOR; payload?: { sourceLanguage?: LanguageCode | 'auto'; targetLanguage?: LanguageCode } };
